//Codigo desarrollado por: Brian Steve Rodas Hernandez
//Carnet: RH18031
...
#include <cstdlib> //Libreia para memora dinamica
#include <stdio.h> //Libreria de opciones de buffer y validaci[on de datos
#include <iostream> //Libreria para entradas y salidas
#include <winsock2.h> //Libreria para corregir errores de socket
#include <windows.h> //Libreria de funciones de windows
#include <mysql.h> //Libreria de mysql para realizar conecciones
#include <mysqld_error.h> //Libreria mysql para corregir errores
...
void bienvenida() {
	...
	cout << "\t\t\t\t1111111111111111111111111111111111111111111111111111111" << endl;
	cout << "\t\t\t\t1                                                     1" << endl;
	cout << "\t\t\t\t1 ++++  + +++++ +   + +   + +++++ +   + + ++++  +++++ 1" << endl;
	cout << "\t\t\t\t1 +   + + +     ++  + +   + +     ++  + + +   + +   + 1" << endl;
	cout << "\t\t\t\t1 ++++  + +++++ + + + +   + +++++ + + + + +   + +   + 1" << endl;
...
void errorhost() { //Funcion para error de host
	cout << "### No es posible conectar al servidor ###" << endl; //Imprimir mensaje de error
    Sleep(1000); //Mantener en pantalla por un segundo
...
void errorconsulta() { //Funcion de error en consulta
	...
	cout << "\t\t\t\t ------------------------------------------------- " << endl;
	cout << "\t\t\t\t|                                                 |" << endl;
	cout << "\t\t\t\t|      ### Error al realizar la consulta ###      |" << endl;
	cout << "\t\t\t\t|                                                 |" << endl;
	cout << "\t\t\t\t ------------------------------------------------- " << endl << endl;
}
...
void novalido() {
	...
	cout << "\t\t\t\t|                                                 |" << endl;
	cout << "\t\t\t\t ------------------------------------------------- " << endl << endl;
	cout << "\t\t\t\t\t    Ingrese un valor valido: "; //Pedir al usauario otro dato
}
