//Programa creado por: Biran Steve Rodas Hernandez
...
int main(int argc, char** argv) {
	...
	while (n<=vn) { //Condicion mientras sea menor o igual a 4
		clear();
		cout << "Ingrese el numero " << n << endl; //Pedir que ingrese los numeros a sumar
